...
import { View, FlatList, ScrollView, TouchableOpacity, Text, StyleSheet, SafeAreaView, Platform } from 'react-native'
...
class Discover extends Component {
  ...
  viewAll = () => {
    this.props.navigation.navigate('ViewAllDiscover')
  }
  eventClickHandle = (id) => {
  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        <ScrollView style={{ paddingLeft: 12, flex: 1, backgroundColor: 'rgb(36,42,56)' }}>
          ...
          <FlatList
            ...
            showsHorizontalScrollIndicator={false}
            initialNumToRender={5}
            data={this.state.trendingPubsData}
            renderItem={({ item }) => (
